  ...
  return (
    <>
      ...
      <nav className="fixed top-0 left-0 w-full h-20 bg-black/20 backdrop-blur-md border-b border-white/5 px-6 flex items-center justify-between z-[100]">
        ...
        <button className="relative w-11 h-11 rounded-full border-2 border-red-600/50 p-0.5 hover:border-red-500 hover:scale-105 transition-all shadow-[0_0_20px_rgba(220,38,38,0.2)]">
